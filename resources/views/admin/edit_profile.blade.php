                        ...
                        <form action="{{ route('adminprofile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3 text-center">
                                    <img src="{{ $user->image ? asset('storage/' . $user->image) : 'assets1/images/users/avatar-1.jpg' }}" alt="Profile Image" class="img-fluid rounded-circle mb-2">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="reference" value="{{ $user->Reference }}" disabled>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="balance"><strong>Balance:</strong></label>
                                            <input type="text" class="form-control" id="balance" value="{{ $user->balance }}" disabled>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-6">
