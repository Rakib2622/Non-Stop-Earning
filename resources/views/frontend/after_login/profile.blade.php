            ...
            <div class="container mt-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <img src="{{ $user->image ? asset('storage/' . $user->image) : 'assets1/images/users/avatar-1.jpg' }}" alt="Profile Image" class="img-fluid rounded-circle">
                            </div>
                            <div class="col-md-9">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <p>{{ $user->referral_link ?? 'N/A' }}</p>
                                        @if ($user->referral_link)
                                            <button class="btn btn-info" onclick="copyReferralLink()">Share</button>
                                        @endif
                                    </div>
                                </div>
                            </div>
