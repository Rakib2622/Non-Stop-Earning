...
<header style="background: linear-gradient(90deg, rgba(255, 223, 186, 0.8), rgba(135, 206, 250, 0.8)); padding: 10px 0; position: absolute; top: 0; width: 100%; z-index: 1000;">
    <div style="display: flex; justify-content: space-between; align-items: center; max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        ...
        <a href="{{ route('login') }}" class="btn" style="background-color: #38b9d9; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; margin-left: 10px; transition: background-color 0.3s;">Sign In</a>
    </div>
</header>
